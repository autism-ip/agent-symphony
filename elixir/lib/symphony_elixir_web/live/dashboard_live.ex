defmodule SymphonyElixirWeb.DashboardLive do
      ...
      <% else %>
        <section class="metric-grid">
          ...
          <article class="metric-card">
            ...
            <p class="metric-value numeric"><%= format_int(@payload.runner_totals.total_tokens) %></p>
            <p class="metric-detail numeric">
              In <%= format_int(@payload.runner_totals.input_tokens) %> / Out <%= format_int(@payload.runner_totals.output_tokens) %>
            </p>
          </article>
  ...
  defp completed_runtime_seconds(payload) do
    payload.runner_totals.seconds_running || 0
  end
